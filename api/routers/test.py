...
user_db = {"curtis": {"username": "curtis", "location": " Alameda", "age": "28"}}
...
@app.get(
    "/users"
)  ## this is the path sending get request to the /user --> this will invoke a function
def get_users():
...
@app.get(
    "/users/{username}"
)  ## {username} is placeholder. This is for looking for specific user
