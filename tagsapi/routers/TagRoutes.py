...
@router.post("/api/tag")
async def post_tag(Tags):
    return 1

@router.get("/api/tag{id}")
async def get_tag(Tags):
    return 1

@router.delete("/api/tag{id}")
async def delete_tag(Tags):
    return 1

@router.put("/api/tag{id}")
async def put_tag(id,data):
    return 1
